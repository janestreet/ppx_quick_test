...
val call : 'tup 'fn 'res. ('tup, 'fn, 'res) t -> 'tup -> 'fn -> 'res

(** Sexp-converters and quickcheck values for ['tup]s. *)

val sexp_of_tup : 'tup 'fn 'res. ('tup, 'fn, 'res) t -> ('tup -> Sexp.t) Staged.t
val tup_of_sexp : 'tup 'fn 'res. ('tup, 'fn, 'res) t -> (Sexp.t -> 'tup) Staged.t
val tup_generator : 'tup 'fn 'res. ('tup, 'fn, 'res) t -> 'tup Quickcheck.Generator.t
val tup_shrinker : 'tup 'fn 'res. ('tup, 'fn, 'res) t -> 'tup Quickcheck.Shrinker.t
