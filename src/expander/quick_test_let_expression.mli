...
(** Creates a [t] given a the [location], [pattern], and [expression] that exist in the
    AST in the form [%%quick_test let PATTERN = EXPRESSION], which comes from the
    [Pstr_value structure_item_desc] associated with the let.
